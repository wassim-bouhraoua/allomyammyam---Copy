...
const { POST } = require('../app/api/orders/items/[orderItemId]/review/route');
...
async function main() {
  ...
  let currentSession = customer;
  sessionModule.getSession = async () => currentSession;
  ...
  currentSession = chefUser; // Chef tries to review
