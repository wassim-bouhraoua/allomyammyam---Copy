...
export default async function ChefProfilePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="min-h-screen bg-[#FFF9F5] flex justify-center py-0 lg:py-12">
      <div className="w-full max-w-md bg-white min-h-screen lg:min-h-0 lg:rounded-[32px] flex flex-col relative shadow-[0_0_80px_rgba(0,0,0,0.07)] lg:border lg:border-gray-100/50 overflow-hidden pb-[78px]">
        ...
        <div className="px-4 -mt-10 mb-6 relative z-10">
          <div className="bg-white rounded-3xl p-5 shadow-[0_4px_28px_rgba(0,0,0,0.08)] border border-gray-100 flex flex-col items-center text-center">
            ...
            {/* Stats Row */}
            <div className="flex items-center gap-3 mt-3.5 border-t border-b border-gray-50 py-2.5 w-full justify-center">
